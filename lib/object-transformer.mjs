 ...
 * @typedef {{[key: string]: import('./jsdoc.common.mjs').rule}} rules
 */
...
/** @type {import('./jsdoc.common.mjs').options} */
 ...
 * @param {import('./jsdoc.common.mjs').rule} [rules._onStart] - A function that runs before all other rules, but after the output._temp object has been created.
 * @param {import('./jsdoc.common.mjs').rule} [rules._onFinish] - A function runs after all other rules, but before the output._temp object has been deleted.
 * @param {import('./jsdoc.common.mjs').options} [options] - An optional options object to change the default options. This gets passed to each function on the rules object.
