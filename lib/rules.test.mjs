  ...
  describe('copy', () => {
    ...
    describe('params object', () => {
      ...
      it.each([
        ...
        ({ propName }) => {
          const copyToKey = rules.copy({ [propName]: 'my.output.key' });
          copyToKey({
            output,
            key: 'the input key',
            value: 'my value',
      ...
      describe('options object', () => {
        ...
        it.each([
          {
            copyOptions: { omitEmptyValues: true },
            expectedOutput: {},
          },
          {
            copyOptions: { omitEmptyValues: false },
            expectedOutput: {
              myEmptyString: '',
            },
          },
        ])(
          'can assign boolean value to options omitEmptyValues to override transformer option property',
