 ...
 * @property {import('./object-transformer.mjs').options} [options] - This can be used to override any options provided by the transformer when it calls the copy rule.
 */
 ...
 * @returns {import('./object-transformer.mjs').rule} Return a rule function for use on the rules object when initializing a transformer.
 */
function copy({
  parser = (v) => v,
  destinationKey,
